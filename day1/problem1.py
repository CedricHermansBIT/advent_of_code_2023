...
for line in inp.splitlines():
    num=[x for x in line if x.isdigit()]
    result+=int(str(num[0])+str(num[-1]))

print(result)

# solution 2
result=0
tdd = {"one":"1", "two":"2", "three":"3",
 "four":"4", "five":"5", "six":"6",
...
for line in inp.splitlines():
    ...
    for i in range(len(line)):
        # check if real digit 1,2,3
        if line[i].isdigit():
            first=line[i]
            break
        # check if line starts with one of "one","two"...
